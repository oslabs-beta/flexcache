...
export default function Terminal() {
  const contentToPrint = [
    ...
    { text: ')', color: 'silver' },
    { text: ';', color: 'silver' },
    { text: '\n\n// Check if key exist in cache', color: 'gray' },
    { text: '\nmyCache', color: 'mediumpurple' },
    { text: '.', color: 'silver' },
    { text: 'has', color: 'gold' },
    { text: '(', color: 'silver' },
    ...
    { text: ')', color: 'silver' },
    { text: ';', color: 'silver' },
    { text: '\n\n// Get stats of cache', color: 'gray' },
    { text: '\nmyCache', color: 'mediumpurple' },
    { text: '.', color: 'silver' },
    { text: 'getStats', color: 'gold' },
    { text: '(', color: 'silver' },
    { text: ')', color: 'silver' },
    { text: ';', color: 'silver' },
    { text: '\n\n// Clear cache stats', color: 'gray' },
    { text: '\nmyCache', color: 'mediumpurple' },
    { text: '.', color: 'silver' },
    { text: 'flushStats', color: 'gold' },
    { text: '(', color: 'silver' },
    { text: ')', color: 'silver' },
    { text: ';', color: 'silver' },
    { text: '\n\n// Reset cache', color: 'gray' },
    { text: '\nmyCache', color: 'mediumpurple' },
    { text: '.', color: 'silver' },
    { text: 'flushAll', color: 'gold' },
    { text: '(', color: 'silver' },
    { text: ')', color: 'silver' },
    { text: ';', color: 'silver' },
    { text: '\n\n// Clear timeout interval that was set initially', color: 'gray' },
    { text: '\nmyCache', color: 'mediumpurple' },
    { text: '.', color: 'silver' },
